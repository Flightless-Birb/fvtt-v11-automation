try {
    ...
    } else if (args[0].macroPass == "isSaveSuccess" && args[0].options.actor.effects.find(e => e.changes.find(c => c.key == "flags.midi-qol.OverTime" && c.value.includes(args[0].item.name)))) {
