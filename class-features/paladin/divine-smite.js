try {
    if (args[0].tag != "DamageBonus" || (!args[0].hitTargets.length && MidiQOL.configSettings().autoRollDamage == "always") || !["mwak"].includes(args[0].item.system.actionType) || !args[0].damageRoll) return;
    let options = "";
