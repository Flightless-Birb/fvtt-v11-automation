try {
	...
	const monsterType = args[0].targets[0].actor.system.details?.type?.value.toLowerCase().includes("humanoid") ? args[0].targets[0].actor.system.details?.type?.subtype.toLowerCase() : args[0].targets[0].actor.system.details?.type?.value.toLowerCase();
