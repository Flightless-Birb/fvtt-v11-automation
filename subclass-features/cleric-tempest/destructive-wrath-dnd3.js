try {
    ...
    if (args[0].macroPass != "preDamageRollComplete" || !["msak", "rsak", "save", "other"].includes(item.system.actionType) || (!args[0].hitTargets.length && MidiQOL.configSettings().autoRollDamage == "always") || !args[0].damageRolls.find(r => r.terms.find(t => t.faces && ["lightning", "thunder"].includes(t.flavor.toLowerCase())))) return;
