try {
	if (args[0].macroPass == "postActiveEffects" && (args[0].hitTargets.length || MidiQOL.configSettings().autoRollDamage != "always") && args[0].damageRolls && ["mwak", "rwak"].includes(args[0].item.system.actionType)) {
		const effectData = {
