try {
    if (args[0].workflow.blessedStrikes) {
    ...
    if (args[0].tag != "DamageBonus" || (!args[0].hitTargets.length && MidiQOL.configSettings().autoRollDamage == "always") || !args[0].damageRoll || !["msak", "rsak", "save", "other"].includes(args[0].item.system.actionType)) return;
