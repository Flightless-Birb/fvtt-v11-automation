    ...
    if (args[0].tag == "OnUse" && args[0].macroPass == "postActiveEffects") {
        ...
        if (weaponOrArmor.type == "weapon") {
            ...
            await weaponOrArmor.update({
                ...
                system: { attackBonus: weaponOrArmor.system.attackBonus + "+1", properties: new Set([...weapon.system.properties].concat(["mgc"])).reduce((obj, str) => ({...obj, [str]: true}), {}), "damage.parts": weaponOrArmor.system.damage.parts.concat([[1, ""]]), "damage.versatile": weaponOrArmor.system.damage.versatile + "+1" }
            });
