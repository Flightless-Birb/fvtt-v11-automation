    ...
    let hook = Hooks.on("summonComplete", async (summonIdNext, summons) => {
        ...
        summons.tokenIds.forEach(async (t) => { 
            ...
            const effectData = { 
                ...
                flags: { ActiveAuras: { aura: "All", displayTemp: false, height: true, hidden: true, hostile: false, ignoreSelf: true, isAura: true, onlyOnce: false, radius: 5, wallsBlock: "true", customCheck: "MidiQOL.typeOrRace(actor.uuid)" }, dae: { stackable: "noneName" } }
            };
