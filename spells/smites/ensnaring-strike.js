try {
    ...
    } else if (args[0].macroPass == "postActiveEffects" && ["mwak", "rwak"].includes(args[0].item.system.actionType) && (args[0].hitTargets.length || MidiQOL.configSettings().autoRollDamage != "always") && args[0].damageRolls) {
        const itemData = {
            name: "Ensnaring Strike",
