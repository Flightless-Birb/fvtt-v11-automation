try {
	if (args[0].macroPass != "postActiveEffects" || (!args[0].hitTargets.length && MidiQOL.configSettings().autoRollDamage == "always") || !["mwak", "rwak", "msak", "rsak"].includes(args[0].item.system.actionType) || !args[0].damageDetail.find(d => d.type == "slashing")) return;
